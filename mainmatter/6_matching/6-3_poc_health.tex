...
\subfigure[with DUODRL concepts.]{
    \fbox{\includegraphics[width=0.4\linewidth]{figures/chapter-6/poc-editor.PNG}}
    \label{fig:editor}
}
\qquad
\subfigure[with OAC and DPV concepts.]{
    \fbox{\includegraphics[width=0.4\linewidth]{figures/chapter-6/poc-dpv-editor.PNG}}
