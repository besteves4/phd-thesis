...
\begin{enumerate}
    ...
    \item Record the outcome of the matching algorithm, where the \texttt{odrl:target} property specifies the dataset to be accessed, and the \texttt{odrl:assignee} and \texttt{odrl:assigner} properties identify the data provider and the requester, respectively.
...
ex:agreement_for_HMB a odrl:Agreement ;
    ...
    odrl:action odrl:use ;
    odrl:target ex:EHR ;
    odrl:assignee ex:provider ;
    odrl:assigner ex:requester ;
    odrl:permission [
        odrl:constraint [
