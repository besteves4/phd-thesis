...
The content of this Chapter has already been partially included in the articles published during this Thesis \citep{esteves_odrl_2021,esteves_using_2022}. % TODO: cite DUODRL paper
\end{tcolorbox}
...
\begin{itemize}
    ...
    % TODO: Mention in the text instead \item \url{https://w3id.org/people/besteves/demo/eswc22}
\end{itemize}
\end{tcolorbox}
