...
%This Chapter presents the state of the art on the representation of policies and personal data processing metadata, as well as their implementation and usage on decentralised data systems, with a particular focus on those solutions that use Semantic Web technologies and cater to requirements of data protection law.
...
% mention that it uses sota from marc mdpi paper when published
...
\input{mainmatter/2_stateoftheart/2-1_solid}
\input{mainmatter/2_stateoftheart/2-2_vocabularies}
\input{mainmatter/2_stateoftheart/2-3_policies}
\input{mainmatter/2_stateoftheart/2-4_challenges}

% https://smashhit.eu/whitepapers/

% https://www.semantic-web-journal.net/content/what-your-cookie-box-explaining-ingredients-web-cookies-knowledge-graphs-0