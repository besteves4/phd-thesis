...
%records of what? this could be explained more clearly, since data controller need to fulfil subject right regardless of whether the platform is decentralised or not.
...
Figure~\ref{fig:gdpr-rights} illustrates the flows of information between a data subject and a data controller for the exercising of a right request.
