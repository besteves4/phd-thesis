...
\begin{itemize}
    ...
    \item \url{https://w3id.org/people/besteves/rights/repo}
\end{itemize}
\end{tcolorbox}
...
\input{mainmatter/4_vocabularies/4-1_background}
...
\input{mainmatter/4_vocabularies/4-6_alignment_iso_27560}