...
As such, the following analysis will be focused in the purpose for processing personal data, as well as in the identity of the data controller, and how they relate to the specific character of consent.
